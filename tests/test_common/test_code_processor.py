...
```'''
    ...
    return n * factorial(n - 1)'''
        ...
        result = self.processor.extract_function_with_helpers(code, "factorial")
        expected_lines = [
            "if n <= 1:",
            "return 1",
            "return n * factorial(n - 1)"
...
def count_primes(numbers):
    ...
    return count'''
        ...
        result = self.processor.extract_function_with_helpers(code, "count_primes")
...
def calculate_distance(point1, point2):
    return math.sqrt((point1[0] - point2[0])**2 + (point1[1] - point2[1])**2)'''
        ...
        result = self.processor.extract_function_with_helpers(code, "calculate_distance")
    ...
    return 42'''
        ...
        result = self.processor.extract_function_with_helpers(code, "nonexistent_function")
        assert result == ""
    
    def test_extract_function_with_helpers_empty_code(self):
        """Test with empty code."""
        result = self.processor.extract_function_with_helpers("", "some_function")
        assert result == ""
